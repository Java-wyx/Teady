 pipeline { 
    ...
    environment { 
        ...
        DOCKER_HUB_CREDENTIALS = credentials('my-dockerhub_id') // Docker Hub credentials ID store in Jenkins
        ...
        stage('Build') { 
            steps { 
                checkout scmGit( 
                    ...
                    extensions: [],  
                    userRemoteConfigs: [[url: 'https://github.com/Java-wyx/Teady.git']] // your github Repository
                ) 
